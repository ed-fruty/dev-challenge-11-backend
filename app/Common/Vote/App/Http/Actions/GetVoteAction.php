...
class GetVoteAction implements VoteRepositoryAwareInterface
{
    use VoteRepositoryAware;

    /**
     * @param $vote
     * @return \App\Common\Vote\Contracts\Vote\VoteInterface
     */
    public function __invoke($vote)
    {
        return $this->voteRepository->findOrFail(new VoteId($vote));
    }
}